# Generated by Django 5.1.4 on 2025-11-28 13:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(blank=True, choices=[('Бигвол', 'Бигвол'), ('Лазерлэнд', 'Лазерлэнд')], max_length=100, verbose_name='Заголовок')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_count', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='Кол-во фотографий')),
                ('payment_type', models.CharField(choices=[('Оплата через парк', 'Оплата через парк'), ('Наличные', 'Наличные'), ('Карта', 'Карта'), ('Оплата по QR коду', 'Оплата по QR коду'), ('Перевод по номеру телефона', 'Перевод по номеру телефона'), ('Предоплаченный заказ', 'Предоплаченный заказ')], default='', max_length=40, verbose_name='Способ оплаты')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dism_status', models.CharField(choices=[('Уволен', 'Уволен'), ('Работает', 'Работает')], default='Работает', max_length=30, verbose_name='Статус')),
                ('date_upd', models.DateTimeField(auto_now=True, verbose_name='Дата изменения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store_status', models.CharField(choices=[('Действующая', 'Действующая'), ('Закрытая', 'Закрытая'), ('Техническая', 'Техническая')], default='Действующая', max_length=30, verbose_name='Статус')),
                ('date_upd', models.DateTimeField(auto_now=True, verbose_name='Дата изменения')),
                ('user_edited', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Кем было изменено')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('position', models.CharField(choices=[('Роль не указана', 'Роль не указана'), ('Администратор', 'Администратор'), ('Фотограф', 'Фотограф'), ('Видеограф', 'Видеограф'), ('Универсальный фотограф', 'Универсальный фотограф'), ('Выездной фотограф', 'Выездной фотограф')], default='Роль не указана', max_length=40, verbose_name='Роль')),
                ('date', models.DateField(verbose_name='Дата')),
                ('work_time', models.CharField(blank=True, max_length=20, null=True, verbose_name='Время работы')),
                ('date_upd', models.DateTimeField(auto_now=True, verbose_name='Дата изменения')),
                ('user_edited', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Кем было изменено')),
                ('staff', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tph_system.staff', verbose_name='Сотрудник')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cnt_logs', models.TextField(blank=True, null=True, verbose_name='Лог расчета')),
                ('date_upd', models.DateTimeField(auto_now=True, verbose_name='Дата изменения')),
                ('user_edited', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Кем было изменено')),
                ('staff', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tph_system.staff', verbose_name='Сотрудник')),
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tph_system.store', verbose_name='Точка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('count', models.DecimalField(decimal_places=1, max_digits=8, verbose_name='Количество на точке')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('week_beg_rec', models.DateField(blank=True, null=True, verbose_name='Дата начала недели за которую забрали зп')),
                ('comment', models.TextField(blank=True, null=True, verbose_name='Комментарий')),
                ('date_upd', models.DateTimeField(auto_now=True, verbose_name='Дата изменения')),
                ('user_edited', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Кем было изменено')),
                ('staff', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tph_system.staff', verbose_name='Сотрудник')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_buy', models.DateField(blank=True, null=True, verbose_name='Дата покупки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Пользователь джанго')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.TextField(blank=True, null=True, verbose_name='Подробности проверки')),
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('date_upd', models.DateTimeField(auto_now=True, verbose_name='Дата изменения')),
                ('user_edited', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Кем было изменено')),
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tph_system.store', verbose_name='Точка')),
